  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='是否使用' prop="shiyongTypes">
                 <el-select v-model="ruleForm.shiyongTypes" disabled  placeholder='请选择是否使用'>
                     <el-option
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.shiyongTypes)&& 'yonghu'==this.flag){
