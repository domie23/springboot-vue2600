        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否使用" prop="shiyongTypes">
                        <el-select v-model="ruleForm.shiyongTypes" :disabled="ro.shiyongTypes" placeholder="请选择是否使用">
                            <el-option
